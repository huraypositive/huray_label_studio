...
from utils import get_db_connection, get_index_db_conncection, get_last_index, get_image_data, get_db
...
def get_image(selected_user, worked_option, class_text_name, multi_option_check):
    ...
    if worked_option:
        ...
        print("여기", selected_user, class_text_name, len(filtered_anno_df))
    else:
        filtered_anno_df = df
...
demo.launch(ssl_verify=False, share=True, server_name="0.0.0.0",server_port=7880,max_threads = 30, show_api = False, state_session_capacity = 1000)
